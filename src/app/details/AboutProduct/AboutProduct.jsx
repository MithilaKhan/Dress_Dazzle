...
<p>Gravida cum sociis natoque penatibus et magnis dis. Feugiat scelerisque varius morbi enim nunc. Ullamcorper a <br /> lacus vestibulum sed arcu non odio euismod lacinia.</p>
    ...
    <TabPanel>
    <div>
            <p className='text-xl'><span className='font-semibold pe-4'> WEIGHT:</span> 1kg  </p>
            <p className='text-xl'><span className='font-semibold pe-4'> DIMENSIONS:</span> 1 x 2 x 3 Cm  </p>
            <p className='text-xl'><span className='font-semibold pe-4'> SIZES:</span> 43WSSDW1  </p>
            <p className='text-xl'><span className='font-semibold pe-4'> COLOR:</span> Black, Blue, Brown, Dove Grey, Red </p>
          </div>
    </TabPanel>
    <TabPanel>
      <h2 className="text-gray-600 font-bold text-2xl">Customer Reviews</h2>
