    ...
    <div className="card  w-full max-w-7xl  backdrop-blur-xl bg-white/30 border-2 border-gray-300 rounded-md shadow-xl bg-base-100">
      <form className="card-body ">
        ...
        <div className="form-control">
          ...
          <input type="name" placeholder="Your Name" className="input input-bordered w-96" required />
        </div>
        ...
        <div className="form-control mt-6 ">
          <button className="button-28">Register Now</button>
        </div>
      </form>
        <p className='text-lg font-semibold ms-7 mb-7 '>Already have an account? please <span className=' underline'> <Link href="/login">Login Now </Link> </span></p>
    </div>
  </div>
</div>
